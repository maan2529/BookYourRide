...
import { useFinishRide } from '../hooks/locationHooks'


const FinishRide = (props) => {
    const { rideDetails, otpMatch } = useContext(socketContext)
    const mitation = useFinishRide()
    ...
    async function endRide() {
        ...
        mitation.mutate(rideDetails?._id, {
            onSuccess: (data) => {
                // last call
        ...
        <div>
            ...
            <div className='flex items-center justify-between p-4 border-2 border-yellow-400 rounded-lg mt-4'>
                <div className='flex items-center gap-3 '>
                    ...
                    <h2 className='text-lg font-medium'>{rideDetails?.user?.firstname}</h2>
                </div>
