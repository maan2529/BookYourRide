...
const LookingForDriver = (props) => {
    const { confirmRideDetails } = useContext(socketContext)
    ...
    return (
        <div>
            ...
            <div className='flex gap-2 justify-between flex-col items-center'>
                ...
                <img className='h-15 self-center' src="https://swyft.pl/wp-content/uploads/2023/05/how-many-people-can-a-uberx-take.jpg" alt="" />
