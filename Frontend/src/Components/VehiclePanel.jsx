...
const VehiclePanel = ({ setVehiclePanel, setConfirmRidePanel }) => {
    return (
        <div>
            ...
            <div onClick={() => setConfirmRidePanel(true)} className='flex border-2 active:border-black  mb-2 rounded-xl w-full p-3  items-center justify-between'>
            ...
            <div className='flex border-2 active:border-black mb-2 rounded-xl w-full p-3  items-center justify-between'>
                ...
                <h2 className='text-lg font-semibold'>76.80</h2>
            </div>
            <div className='flex border-2 active:border-black mb-2 rounded-xl w-full p-3  items-center justify-between'>
